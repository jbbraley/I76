...
% fnames = {'I76_07272015_ambient3.txt';...
%           'I76_07272015_ambient3_01.txt';...
%           'I76_07272015_ambient3_2.txt';...
%           'I76_07272015_ambient3_3.txt'};
% 
...
pname = 'F:\I76\07272016_Data';      
fname_base = 'I76_07272015_ambient_PM2';
...
%% Get RMS of filtered data (remove high frequency acceleration)
%Apply lowpass filter
fcut = 20; % Frequency cut-off
order = 6; % Order of filter
rip = 0.5; % passband ripple (dB)
stop_at = 40; % magnitude of stopband attenuation (dB)
[b,a] = ellip(order,rip, stop_at, fcut/(fs/2),'low');
freqz(b,a,32000,fs)

dat_filt = filter(b,a,data);

rmsDatF = getrms(dat_filt);
